...
public class ContatoDao {
	...
	public Contato listaContato(long id) throws SQLException {
		...
		while (query.next()) {
			contato1.setId(id);
			contato1.setNome(query.getString("nome"));
			contato1.setEmail(query.getString("email"));
			contato1.setEndereco(query.getString("endereco"));
			Calendar data = Calendar.getInstance();
