...
public class MediaMovelSimplesTest {
	...
	public void sequenciaSimplesDeCandles() {
		...
		Assert.assertEquals(10.0, mms.calcula(4, serie), 0.00001);
		Assert.assertEquals(11.0, mms.calcula(5, serie), 0.00001);
		Assert.assertEquals(4.0, mms.calcula(6, serie), 0.00001);
		Assert.assertEquals(13.0, mms.calcula(7, serie), 0.00001);
